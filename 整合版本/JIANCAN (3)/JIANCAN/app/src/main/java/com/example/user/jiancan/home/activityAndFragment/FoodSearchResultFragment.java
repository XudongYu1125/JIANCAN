...
//        loadGridDate ();
    ...
    private void loadTrueData(){
        ArrayList<HomeListItemBean> dataBeanList = new ArrayList <> ();
        dataBeanList = getHomeListItemBean ();
        //创建适配器adapter对象 参数1.上下文 2.数据加载集合
        recyclerViewGridAdapter = new RecyclerViewGridAdapter (getContext(), dataBeanList);
        //设置适配器
        mFoodSearchResultRecyclerview.setAdapter(recyclerViewGridAdapter);
