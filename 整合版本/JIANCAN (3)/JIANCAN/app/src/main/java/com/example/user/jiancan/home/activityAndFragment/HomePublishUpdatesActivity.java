...
public class HomePublishUpdatesActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    Toast.makeText(HomePublishUpdatesActivity.this, "上传失败，网络有问题", Toast.LENGTH_LONG).show();
                    break;
                case 2:
                    Toast.makeText(HomePublishUpdatesActivity.this, "上传成功，即将前往个人动态", Toast.LENGTH_LONG).show();
                    ...
                    break;
                case 3:
                    Toast.makeText(HomePublishUpdatesActivity.this, "上传成功", Toast.LENGTH_LONG).show();
                    Intent intent1 = new Intent(HomePublishUpdatesActivity.this, PersonalTrendsListActivity.class);
                    intent1.putExtra("activityFrom","HomePublishUpdatesActivity");
    ...
    public void uploadFiles(String url) {
        ...
        foods.setUserId(user.getId());
        foods.setVegetablesId(3);
        foods.setFoodName(title.getText().toString());
        Gson gson = new Gson();
