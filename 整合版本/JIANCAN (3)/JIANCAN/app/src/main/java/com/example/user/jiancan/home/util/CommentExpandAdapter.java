...
import static com.example.user.jiancan.home.activityAndFragment.FoodListItemDetail.likeItem;
...
import static com.example.user.jiancan.home.activityAndFragment.FoodListItemDetail.unLikeItem;
...
public class CommentExpandAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView( final int groupPosition , final boolean isExpanded , View convertView , ViewGroup parent ) {
        ...
        //用户头像显示
        String path = "http://39.97.3.111:8080/JianCanServerSystem/upload/avatarimgs/";
        otherUserImgUrl = commentBeanList.get(groupPosition).getUserLogo();
        Glide.with (context).load (path+otherUserImgUrl)
