...
import com.example.user.jiancan.FindPasswordActivity;
        ...
        singleTask.execute (new Runnable ( ) {
            ...
            public void run() {
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
                    if (ActivityCompat.checkSelfPermission(FoodCategoryItemDetail.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(FoodCategoryItemDetail.this, PERMISSIONS_STORAGE, REQUEST_PERMISSION_CODE);
                    }
                }
            }
        });
