...
import com.example.user.jiancan.home.activityAndFragment.HomeFragment;
import com.example.user.jiancan.message.activityAndFragment.MessageFragment;
import com.example.user.jiancan.personal.activityAndFragment.PersonalFragment;
...
public class TabHostActivity extends AppCompatActivity {
    ...
    private String [] tabStr = {"首页","消息","我的"};
    private Class[] fragementArr = {HomeFragment.class, MessageFragment.class, PersonalFragment.class};
    //一般状态的显示图标
    private int [] imageArr = {R.drawable.tabhost_home_normal,R.drawable.tabhost_msg_normal,R.drawable.tabhost_personal_normal};
    //选中状态的显示图标
    private int [] imgArr = {R.drawable.tabhost_home_selected,R.drawable.tabhost_msg_selscted,R.drawable.tabhost_personal_selected};
