...
public class PersonalHistoryAdapter extends BaseAdapter {
    ...
    public PersonalHistoryAdapter(List<Food> foods,User user, int item_id, Context context,SparseBooleanArray stateCheckedMap) {
        this.foods = foods;
        this.user = user;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.checkBox.setChecked(stateCheckedMap.get(position));//设置CheckBox是否选中Set<Image> image = foods.get(position).getImages();
